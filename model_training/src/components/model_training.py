...
class ModelTraining:
    ...
    def initiate_model_trainer(self):
        try:
            ...
            valid_df = pd.read_csv(self.data_ingestion_artifact.train_file_path)
            valid_data = datasets.Dataset.from_pandas(valid_df)
            ...
            #         torch.save(model.state_dict(), self.model_trainer_config.model_training_dir)
